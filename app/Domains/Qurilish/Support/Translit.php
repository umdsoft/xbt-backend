...
/**
 * O'zbek kirill → lotin transliteratsiyasi (ko'rsatish va solishtirish uchun).
 *
 * Manba xlsx aralash: tashkilot nomlari ba'zan kirill, ba'zan lotin; obyekt
 * nomlari va sohalar kirill. Tuman/mahalla nomlari uchun `master.name_lat`
 * afzal (rasmiy), bu esa qolgan erkin matnlar uchun mexanik o'girish.
 *
 * Sport domenidagi bir xil sinfning nusxasi — domenlar bir-biriga bog'lanmasin.
 */
final class Translit
{
    ...
    public static function toLatin(?string $s): ?string
    {
        ...
        // Kirill bo'lmasa (allaqachon lotin) — o'zgartirmaymiz.
