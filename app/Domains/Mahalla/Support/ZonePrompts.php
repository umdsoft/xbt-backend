...
final class ZonePrompts
{
     ...
     */
    // DIQQAT: kalitlar (facade/kitchen/toilet/yard) tarixiy barqaror kodlar —
    // MahallaZones bilan mos. Obodonlashtirish uchun kriteriya matni yangilangan:
    // kitchen→Хона-таҳона, toilet→Эҳота-дарвоза, yard→Томирқа.
    private const CRITERIA = [
        'facade' => 'ФАСАД (уй ташқи кўриниши): девор ва сувоқ ҳолати, бўёқ, том/шифер, деразалар/ромлар, кўча томон тозалиги. Ободонлаштириш ва таъмир белгилари.',
        'yard' => 'ТОМИРҚА (ер участкаси): ер ҳолати — ўт/бегона ўт босганми, ташландиқми, тозаланганми, экишга тайёрланган (ҳайдалган/текисланган)ми, экин экилганми, парваришланяптими. Кўкаламзорлаштириш босқичи.',
        'kitchen' => 'ХОНА-ТАҲОНА: яшаш хоналари ва таҳона/ёрдамчи хўжалик бинолари — девор ва том ҳолати, таъмир, тозалик ва ободонлаштириш белгилари.',
        'toilet' => 'ЭҲОТА-ДАРВОЗА: ҳовли эҳотаси (девор/панжара) ва дарвоза — бутунлиги, бўёқ ва таъмир, ташқи кўриниш ва ободонлаштириш ҳолати.',
    ];
