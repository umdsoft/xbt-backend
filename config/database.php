...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // MARKAZIY IDENTIFIKATSIYA (auth schema) — yagona identifikatsiya manbai.
        'auth' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_AUTH_SEARCH_PATH', 'auth,public'),
            'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],

        // MASTER geo (yagona statik ma'lumot) — read-mostly.
        'master' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_MASTER_SEARCH_PATH', 'master,public'),
            'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],

        // MAHALLA domeni (operatsion) — houses/photos/analyses + geo (master) + profil.
        'mahalla' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_MAHALLA_SEARCH_PATH', 'mahalla,master,public'),
            'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],
        ...
        'sport' => [
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_SPORT_SEARCH_PATH', 'sport,master,public'),
            'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],
        ...
        'hr' => [
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_HR_SEARCH_PATH', 'public,master'),
            'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],
